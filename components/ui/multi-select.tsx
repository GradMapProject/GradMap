      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-lg border min-h-14 h-auto items-center justify-between bg-inherit hover:bg-inherit",
              className
            )}
          >
            {selectedValues.length > 0 ? (
              <div className="flex justify-between items-center w-full">
                ...
                <div className="flex items-center justify-between">
                  <Button size="icon" className="p-0 mx-1" onClick={(event) => {
                        event.stopPropagation();
                        console.log("HELLLO DANIEL!!!");
                        handleClear();
                      }} variant="invisible">
                    <XIcon
